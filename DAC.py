...
def changePriv():
    ...
    fileNo = int(input())
    print("Change access to: r-1   w-2   rw-3   rx-4   rwx-5")
    newPriv = int(input())
...
def printMatrix():
    ...
    print(" User1 | "+perm.get(matrix[1][1])+" | "+perm.get(matrix[1][1])+" | "+perm.get(matrix[1][2])+" | "+perm.get(matrix[1][3])+" | "+perm.get(matrix[1][4])+" | "+perm.get(matrix[1][5]))
    print(" User1 | "+perm.get(matrix[2][2])+" | "+perm.get(matrix[2][1])+" | "+perm.get(matrix[2][2])+" | "+perm.get(matrix[2][3])+" | "+perm.get(matrix[2][4])+" | "+perm.get(matrix[2][5]))
    print(" User1 | "+perm.get(matrix[3][3])+" | "+perm.get(matrix[3][1])+" | "+perm.get(matrix[3][2])+" | "+perm.get(matrix[3][3])+" | "+perm.get(matrix[3][4])+" | "+perm.get(matrix[3][5]))
    print(" User1 | "+perm.get(matrix[4][4])+" | "+perm.get(matrix[4][1])+" | "+perm.get(matrix[4][2])+" | "+perm.get(matrix[4][3])+" | "+perm.get(matrix[4][4])+" | "+perm.get(matrix[4][5]))
    if __name__ == "__main__":
        main()
